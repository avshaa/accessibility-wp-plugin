...
include_once('Thetwoaccessibility_InstallIndicator.php');

class Thetwoaccessibility_LifeCycle extends Thetwoaccessibility_InstallIndicator
{
    ...
    public function menu_button($items, $args)
    {
    ...
    {
        $setting_page = get_class($this);
        return $setting_page . 'Settings';
    }
    ...
    protected function addSettingsPageToMenu()
    {
        $this->requireExtraPluginFiles();
        $displayName = $this->getPluginDisplayName();
        add_menu_page(
