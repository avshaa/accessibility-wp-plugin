(function($) {
	...
	var initalFontSize = $("html").css("font-size");
	...
	$("#close-accessibility").on("click", function(e) {
		e.preventDefault;
		$("#accessibility-button")
			.attr("data-state", "closed")
			.removeClass("active");
	...
	function goLightContrast(state) {
		if (state == "enable") {
			var logoBlack =
				baseUrl + "/wp-content/themes/segev/images/logo-black.png";
	...
	function goDarkContrast(state) {
		if (state == "enable") {
			var logoYellow =
				baseUrl + "/wp-content/themes/segev/images/logo-yellow.png";
	...
	$("#accessibility-original-font").click(function() {
		$("html").css("font-size", initalFontSize);
	});
