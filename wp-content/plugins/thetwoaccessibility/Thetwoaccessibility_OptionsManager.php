...
class Thetwoaccessibility_OptionsManager
{
    ...
    public function settingsPage()
    {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'thetwoaccessibility'));
        }
        ...
        ?>
<div class="wrap">
    <h2><?php _e('System Settings', 'thetwoaccessibility'); ?></h2>
    <table cellspacing="1" cellpadding="2">
        <tbody>
            <tr>
                <td><?php _e('System', 'thetwoaccessibility'); ?></td>
                <td><?php echo php_uname(); ?></td>
            </tr>
            <tr>
                <td><?php _e('PHP Version', 'thetwoaccessibility'); ?></td>
                <td><?php echo phpversion(); ?>
                    <?php
                            if (version_compare('5.2', phpversion()) > 0) {
                                echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                                _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'thetwoaccessibility');
                                echo '</span>';
                            }
                            ?>
                </td>
            ...
            <tr>
                <td><?php _e('MySQL Version', 'thetwoaccessibility'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                            echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                            if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                                _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'thetwoaccessibility');
                            }
                            echo '</span>';
                            ?>
                </td>
    ...
    <h2><?php echo $this->getPluginDisplayName();
                echo ' ';
                _e('Settings', 'thetwoaccessibility'); ?></h2>
    ...
    <form method="post" action="">
        ...
        <p class="submit">
            <input type="submit" class="button-primary" value="<?php _e('Save Changes', 'thetwoaccessibility') ?>" />
        </p>
    </form>
</div>
<?php
...
<?php
    ...
    protected function getOptionValueI18nString($optionValue)
    {
        switch ($optionValue) {
            case 'true':
                return __('true', 'thetwoaccessibility');
            case 'false':
                return __('false', 'thetwoaccessibility');

            case 'Administrator':
                return __('Administrator', 'thetwoaccessibility');
            case 'Editor':
                return __('Editor', 'thetwoaccessibility');
            case 'Author':
                return __('Author', 'thetwoaccessibility');
            case 'Contributor':
                return __('Contributor', 'thetwoaccessibility');
            case 'Subscriber':
                return __('Subscriber', 'thetwoaccessibility');
            case 'Anyone':
                return __('Anyone', 'thetwoaccessibility');
        }
        return $optionValue;
    }
